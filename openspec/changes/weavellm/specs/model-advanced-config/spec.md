...
Sampler overrides (temperature, top_p, min_p, typical_p, top_k, repeat_penalty) SHALL be settable per llm.call node and applied per call.

#### Scenario: Node-level override applied

- GIVEN a llm.call node with custom samplers
